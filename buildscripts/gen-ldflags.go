...
func genLDFlags(version string) string {
	...
	ldflagsStr := "-s -w"
	ldflagsStr += " -X github.com/wrkode/openbucket/cmd.Version=" + version
	ldflagsStr += " -X github.com/wrkode/openbucket/cmd.CopyrightYear=" + copyrightYear
	ldflagsStr += " -X github.com/wrkode/openbucket/cmd.ReleaseTag=" + releaseTag
	ldflagsStr += " -X github.com/wrkode/openbucket/cmd.CommitID=" + commitID()
	ldflagsStr += " -X github.com/wrkode/openbucket/cmd.ShortCommitID=" + commitID()[:12]
	ldflagsStr += " -X github.com/wrkode/openbucket/cmd.GOPATH=" + os.Getenv("GOPATH")
	ldflagsStr += " -X github.com/wrkode/openbucket/cmd.GOROOT=" + os.Getenv("GOROOT")
	return ldflagsStr
}
