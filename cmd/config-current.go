...
import (
	...
	"github.com/wrkode/openbucket/internal/config/callhome"
	"github.com/wrkode/openbucket/internal/config/compress"
	"github.com/wrkode/openbucket/internal/config/dns"
	"github.com/wrkode/openbucket/internal/config/drive"
	...
	idplugin "github.com/wrkode/openbucket/internal/config/identity/plugin"
	xtls "github.com/wrkode/openbucket/internal/config/identity/tls"
	"github.com/wrkode/openbucket/internal/config/ilm"
	"github.com/wrkode/openbucket/internal/config/lambda"
	"github.com/wrkode/openbucket/internal/config/notify"
	"github.com/wrkode/openbucket/internal/config/policy/opa"
	polplugin "github.com/wrkode/openbucket/internal/config/policy/plugin"
	"github.com/wrkode/openbucket/internal/config/scanner"
